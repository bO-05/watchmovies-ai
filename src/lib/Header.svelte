...
>
	<button on:click class="flex items-center mb-4 md:mb-0 text-white/70">
		<TvIcon />
		<div class="text-2xl md:text-xl font-bold ml-2">watchmovies-ai</div>
	</button>
	<a
		...
		href="https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2FbO-05%2Fwatchmovies-ai&env=VITE_OPENAI_API_KEY&envDescription=Open%20AI%20API%20key&demo-title=watchmovies-ai&demo-url=https%3A%2F%2Fwatchmovies-ai.vercel.app"
	>
